...
public struct GFPDFConfiguration {
    ...
    public var scrollVertically = false // if true the PDF will scroll vertically
    public var usePDFKit = true // set to false to use PDFScrollViewController (if you need iOS <= 10)
